...
class ShellMapShader : public Magnum::GL::AbstractShaderProgram {
 public:
  ...
  // } 
  // TODO into cpp
  void compute(size_t N, Magnum::GL::Buffer &Xws, Magnum::GL::Buffer &B0, Magnum::GL::Buffer &DinvU, Magnum::GL::Buffer &NNv, Magnum::GL::Buffer &mX, Magnum::GL::Buffer &mF, Magnum::GL::Buffer &mFms, Magnum::GL::Buffer &mdefF, Magnum::GL::Buffer &mdefFv, Magnum::GL::Buffer &U, bool apply, bool flat_normals, float phong) {
    Xws.bind(Magnum::GL::Buffer::Target::ShaderStorage, VertexBuffer);
