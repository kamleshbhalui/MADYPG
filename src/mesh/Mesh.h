...
// compute signed angle from u to v over e, e has unit length and is orthogonal to u,v
...
private:
  AlignedVector<Vector3i> Fmsadj; // (ordered) vertices opposite of the face's edges (or -1 if non-existent)
